...
class Game:    
    def __init__(self):
        ...
        self.font = pygame.font.Font('Truong\'sclone/Arial.ttf', 32)
        self.running = True
        self.boss_defeated = False
        self.character_spritesheet = Spritesheet('Truong\'sclone/img/character.png')
        self.terrain_spritesheet = Spritesheet('Truong\'sclone/img/terrain.png')
        self.enemy_spritesheet = Spritesheet('Truong\'sclone/img/enemy.png')
        self.attack_spritesheet = Spritesheet('Truong\'sclone/img/attack.png')
        self.intro_background = pygame.image.load('Truong\'sclone/img/introbackground.png')
        self.gameover_background = pygame.image.load('Truong\'sclone/img/gameover.png')
        self.glock_spritesheet = Spritesheet('Truong\'sclone/img/Glock-SpriteSheet.png')
        self.ak47_spritesheet = Spritesheet('Truong\'sclone/img/AK47-SpriteSheet.png')
        self.sniper_spritesheet = Spritesheet('Truong\'sclone/img/SniperRifle-SpriteSheet.png')
        self.boss_spritesheet = Spritesheet('Truong\'sclone/img/boss1.jpg')
